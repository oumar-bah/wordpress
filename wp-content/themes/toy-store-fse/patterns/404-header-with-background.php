<?php
  ...
  * Slug: toy-store-fse/404-header-with-background
  */
?>
...
<p class="has-text-align-center has-foreground-color has-text-color has-content-heading-font-size"><?php esc_html_e('Oops! That page cannot be found','toy-store-fse'); ?></p>
<!-- /wp:paragraph -->
